...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[
        box/.style={rectangle, draw, minimum width=2.2cm, minimum height=0.9cm, text centered, font=\scriptsize, align=center},
        dut/.style={box, fill=yellow!20, thick},
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[
        box/.style={rectangle, draw, minimum width=2.5cm, minimum height=1.1cm, text centered, font=\small, align=center, rounded corners=2pt},
        dut/.style={box, fill=yellow!20, thick},
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[
        box/.style={rectangle, draw, minimum width=2.5cm, minimum height=1.2cm, text centered, font=\small, align=center, rounded corners=2pt},
        ...
        \node[router] (huawei_a) at (0, 3) {Huawei\\EG8245W5-8T\\[1pt]{\scriptsize Router Mode}};
        \node[box] (pc_a) at (0, 0.5) {Test PC\\[1pt]{\scriptsize 1--4 ports}};
        ...
        \node[bridge] (huawei_b) at (8.5, 3.5) {Huawei\\[1pt]{\scriptsize Bridge Mode}};
        \node[router] (asus_b) at (8.5, 1.5) {Asus\\RT-AX68U\\[1pt]{\scriptsize Router}};
        \node[box] (pc_b) at (8.5, -1) {Test PC\\[1pt]{\scriptsize 1--4 ports}};
        \node[meter] (meter_b1) at (5.5, 3.5) {DECT~200\\[1pt](option a)};
        \node[meter] (meter_b2) at (5.5, 1.5) {DECT~200\\[1pt](option a)};
        \node[meter] (meter_b_shared) at (11.5, 2.5) {DECT~200\\[1pt]{\scriptsize option b:\\via strip}};
